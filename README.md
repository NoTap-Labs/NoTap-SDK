...
* 🌐 **Website:** [notap.](https://notap.xyz)io
* 📚 **Documentation:** [docs.notap](https://docs.notap.xyz).io
...
_Your identity is a master key that opens any door — but it lives in your mind, not your pocket._

[![License: Apache 2.0](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0) [![Kotlin](https://img.shields.io/badge/kotlin-1.9+-blue.svg)](https://kotlinlang.org) [![PSD3 SCA Compliant](https://img.shields.io/badge/PSD3-SCA%20Compliant-green.svg)](https://www.ecb.europa.eu)
...
| **Rhythm**  | Tap pattern you create | _tap-tap---tap-tap-tap_           |
...
> _You're at the airport. Flight boards in 20 minutes. Phone battery: 0%. You need coffee._
>
...
> _Your phone is in your locker (hospital rules). A patient needs medication from the secure cabinet. Now._
>
...
> _Phone locked in the car (smart). Kids want ice cream._
>
...
> _You're at a theme park with the family. You want to store everything in a locker — phone, wallet, everything — and just enjoy the rides worry-free._
>
...
> _It's 2 AM. You're stranded. Your credit card was declined. You need a taxi home._
>
...
> _Finished your workout. Wallet and phone locked in the locker. Just want a smoothie._
>
...
> _I see a future where people live freer: shop at the beach risk-free, travel worry-free, and businesses attract customers who used to abandon carts. NoTap isn't just authentication; it's pure freedom._
...
> _And you — how do you see the future? Can you imagine the potential this has in the markets you know?_
...
[Website](https://notap.io) • [Documentation](https://docs.notap.io) • [GitHub](https://github.com/keikworld/zero-pay-sdk)
...
* 🐦 **Twitter:** [@NoTapAut](https://twitter.com/NoTapAuth)h
...
For SDK licensing, contact: licensing@notap.io
...
[Website](https://notap.xyz) • [Docs](https://docs.notap.xyz) • [Twitter](https://twitter.com/NoTapAuth)
