...
**URL:** `https://developer.notap.io/signup`
...
```
From: NoTap Developer Portal <noreply@notap.io>
...
```
❌ http://api.notap.io/v1/enrollment
✅ https://api.notap.io/v1/enrollment
```
...
const NOTAP_BASE_URL = 'https://sandbox.api.notap.io';

// After (Production)
const NOTAP_API_KEY = process.env.NOTAP_API_KEY; // sk_live_...
const NOTAP_BASE_URL = 'https://api.notap.io';
```
...
- **Email Support:** [support@notap.io](mailto:support@notap.io)
- **Discord Community:** [https://discord.gg/notap](https://discord.gg/notap)
- **Status Page:** [https://status.notap.io](https://status.notap.io)
