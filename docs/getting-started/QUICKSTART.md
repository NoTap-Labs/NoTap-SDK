...
Visit: **https://developer.notap.io/signup**
...
```kotlin
repositories {
    maven { url = uri("https://maven.notap.io/releases") }
}
...
1. Open your web app
2. Complete the factor canvases (3 minimum)
...
Add at least 3 factors (6+ recommended):
...
2. **Check API endpoint:**
   - Sandbox: `https://sandbox.api.notap.io`
...
- **API Reference:** [https://api-docs.notap.io](https://api-docs.notap.io)
- **Integration Guides:**
...
**Email Support:**
[support@notap.io](mailto:support@notap.io)
- Technical support
- Integration assistance
- Response time: 24-48 hours (free tier)

**GitHub:**
- [Report Issues](https://github.com/keikworld/zero-pay-sdk/issues)
- [Sample Apps](https://github.com/keikworld/zero-pay-sdk)
- [SDK Source Code](https://github.com/keikworld/zero-pay-sdk)

**Status Page:**
[https://status.notap.io](https://status.notap.io)
- API uptime
- Planned maintenance
- Incident reports
...
**[Create Account](https://developer.notap.io/signup) →**
